import { Mail, Github, Twitter, Linkedin, MapPin, Phone, MessageSquare, Heart, Users, BookOpen, Handshake, Target, Globe } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-emerald-50/30 to-teal-50/30 dark:from-gray-900 dark:via-emerald-950/30 dark:to-teal-950/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          {[
            { number: "500+", label: "Jovens Impactados", icon: Users },
            { number: "15", label: "Cursos Gratuitos", icon: BookOpen },
            { number: "50+", label: "Voluntários Ativos", icon: Heart },
            ...
            <button className="border-2 border-white text-white px-6 py-3 rounded-lg font-medium hover:bg-white hover:text-emerald-600 transition-colors">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Conte-nos mais sobre sua ideia ou projeto..."
                ></textarea>
              </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contato@tuxlaboratory.dev" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                      contato@tuxlaboratory.dev
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="https://twitter.com/tuxlaboratory" 
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                    >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="https://linkedin.com/company/tux-laboratory" 
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                    >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Projetos Open Source</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Contribua com nossos projetos existentes ou proponha novos projetos
                  </p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Consultoria Técnica</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Ajuda com arquitetura, escolha de tecnologias e melhores práticas
                  </p>
                </div>
                <div className="border-l-4 border-purple-500 pl-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Mentorias</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Compartilhamento de conhecimento e orientação técnica
                  </p>
                </div>
                <div className="border-l-4 border-orange-500 pl-4">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Parcerias</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm">
                    Colaborações em projetos e iniciativas tecnológicas
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                ...
                Para projetos urgentes, entre em contato diretamente via email.
              </p>
            </div>
          </div>
        </div>
